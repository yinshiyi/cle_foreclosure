...
a$Addressshort=paste(b,'\n',as.character(a$price),as.character(a$soldprice),as.character(a$white),as.character(a$asian),as.character(a$income))
a[which(a$Address=="2476 Derbyshire Rd"),'Addressshort']=c("2476 Derbyshire Rd \n listed, sold, white, asian, income")
plot <-
  ...
  ggtitle(paste("Plot of previous autction",as.character(Sys.Date())))
